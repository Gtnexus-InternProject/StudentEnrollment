...
router.param('userName', function(req, res, next, userName) {
    ...
    // id = "" + id;
    //find the ID in the Database
    mongoose.model(req.type).findOne({userName: userName}, function (err, user) {
...
router.route('/:type/:userName/subjects')
  .get(function(req, res) {
    ...
    mongoose.model(req.type).findOne({userName:req.userName},'subjects', function (err, subjects) {
      // console.log('ID: ' + req.params.id);
...
router.put('/:type/:userName/subjects', function(req, res) {
   ...
   //find the document by ID
      ...
      if (errors) {
        ...
        mongoose.model(req.type).findOneAndUpdate({userName:req.userName}, {"$push": {subjects:req.body.subjects}}, {upsert:true, new: true}, function (err, place) {
            //update it
...
router.delete('/student/:userName/subjects', function (req, res){
    ...
    mongoose.model('student').findOneAndUpdate({userName:req.userName}, {"$pull": {subjects:req.body.subjects}}, { new: true}, function (err, place) {
        //update it
