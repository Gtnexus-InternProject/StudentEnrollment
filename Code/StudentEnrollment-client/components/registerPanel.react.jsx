...
import {
    Panel, Form, FormControl, FormGroup, ControlLabel, HelpBlock, Checkbox, Radio, Button, PageHeader, Col
}
  ...
  console.log(1);
        ...
        render() {
            ...
            onChange = {
                ...
                < ControlLabel > Z - Score < /ControlLabel> < FormControl type="number" min="-4" max="4" step="0.1"
            ...
            /> < /FormGroup > < /Col> < Button bsStyle = "danger"
            type = "button" >
